...
<span style="font-size:30px;cursor:pointer" onclick="openNav()">&#9776;</span>
	...
	<div class="content">
	<a href="restViewProc?restNum=21">Ωƒ¥Á21π¯ ¡§∫∏ ∫∏±‚</a>
	<div>
	...
	<div class="search">
	<input type="search" class="search-txt" style="width:800px; height:50px;" name="" placeholder="∏ﬁ¥∫ ∞Àªˆ">
	</div>
        ...
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <div class="align-self-center collapse navbar-collapse flex-fill  d-lg-flex justify-content-lg-between" id="templatemo_main_nav">
                ...
                <c:if test = "${member == null }">
                  <div class="login_area"><a href="${root}index?formpath=login">Î°úÍ∑∏Ïù∏</a></div>
                    <span><a href="${root}index?formpath=member">ÌöåÏõêÍ∞ÄÏûÖ</a></span>                
                </c:if>  
                    </a>
                ...
                <c:if test="${ member != null }">
            		<div class="login_success_area">
                        <span>ÌöåÏõê : ${member.nickname}Îãò</span>
...
>>>>>>> 36b4fb72f7f2da4ba6bfb612a52a009fd89f56ed
    ...
    <script src="./resourcess/js/bootstrap.bundle.min.js"></script>
