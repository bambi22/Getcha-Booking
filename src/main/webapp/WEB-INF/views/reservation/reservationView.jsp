		...
		<tr>
			...
			<c:choose>
				<c:when test="${reservationView.status eq '완료상태'}">
					<button type="button" class="btn_btn" onclick="location.href='index?formpath=write&restName=${reservationView.restName }&restNum=${reservationView.resNum}'">리뷰 쓰기</button>
				</c:when>
				<c:otherwise>
